...
int main() {
  ...
  cout<< "Now finna test that remove B"<<endl;
  int ex = remove_matching_elements(v1,100);
  cout<<"Killed this many items: "<<ex<<endl;
  print(v1);
  int pex = remove_matching_elements(v1,15);
  cout<<"Killed this many items: "<<pex<<endl;
  print(v1);
cout<<endl;
  cout<<"Lots of pushes"<<endl;
  for(int i =0; i<30;i++){
    v1.push_back(1337);
  }
  print(v1);
